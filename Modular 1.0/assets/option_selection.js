...
Shopify.each = function(t, e) {
    ...
    // console.dir(e); // Array[6] - 0: "S", 1: "M", etc
    ...
    this.onVariantSelected = Shopify.isDefined(e.onVariantSelected) ? e.onVariantSelected : function() {}, this.replaceSelector(t), this.initDropdown(), e.enableHistoryState && (this.historyState = new Shopify.OptionSelectors.HistoryState(this)), !0
    ...
    var e = document.getElementById(t),
        o = e.parentNode; // <div class="productForm-block">
    ...
    var e = Shopify.urlParam("variant"); // exactly what is should be, an integer
    ...
    var o = this.selectorDivClass,
        ...
        r = Shopify.map(this.selectors, function(t) {
            ...
            if (e.setAttribute("class", o), i.length > 1) {
                ...
                r.htmlFor = t.element.id, r.innerHTML = t.name.name, e.appendChild(r)
            } 
    ...
    // onVariantSelected comes from onVariantSelected method of Shopify.ObjectSelectors() in product.liquid
    this.onVariantSelected(i, this, e), null != this.historyState && this.historyState.onVariantChange(i, this, e)
}, 


/*
 * Get Options Selector
 */
